#!/usr/bin/env python3
"""
Backend Server – Admin Panel + Analytics (Production)
...
class SecurityLogger:
    ...
    def init_app(self, app):
        ...
        access_handler = RotatingFileHandler(
            BACKEND_ACCESS_LOG, 
            maxBytes=50_000_000,  # 50MB for production
            backupCount=30,
            encoding='utf-8'
        )
...
# =====================================================
# RUN SERVER WITH WAITRESS (PRODUCTION)
# =====================================================
...
if __name__ == '__main__':
    ...
    print("="*60)
    print("CPP Website Backend Admin Server (PRODUCTION)")
    print("="*60)
    ...
    serve(
        ...
        channel_timeout=300,  # 5 minutes timeout for file uploads
        clear_untrusted_proxy_headers=False,
        ident=f'CPP-Backend/{args.port}'
    )